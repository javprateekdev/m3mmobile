...
const Brochure = () => {
  ...
  <div style={{display:"flex",padding:"5%"}}>
    <div className='brochureimg'  ><div><img src="http://m3m-properties.net/m3m-94/images/e-brochure.jpg" style={{border:"8px solid  #b5943b"}}/></div></div>
    <div  className='brochuretext' >
        <div className='brochureheading'>
